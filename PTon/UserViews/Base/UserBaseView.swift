            ...
            .toolbar {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    HStack{
                        ...
                        NavigationLink {
                            UserChattingView(viewModel: UserChattingViewModel(userId: UserBaseViewModel.userid, trainerId: UserBaseViewModel.trainerid, fitnessCode: UserBaseViewModel.fitnessCode, userName: UserBaseViewModel.username, trainerName: UserBaseViewModel.trainerName))
                        } label: {
